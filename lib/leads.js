...
export async function createLead(data) {
  ...
  const [result] = await pool.execute(
    `INSERT INTO leads
      (first_name, last_name, email, phone, service, preferred_contact, coverage_needs, tax_support, message, attachment_name, attachment_type, attachment_data, status)
     VALUES
      (:firstName, :lastName, :email, :phone, :service, :preferredContact, :coverageNeeds, :taxSupport, :message, :attachmentName, :attachmentType, :attachmentData, 'new')`,
    {
      message: null,
      attachmentName: null,
      attachmentType: null,
