...
import { DEFAULT_LOCALE, LANGUAGE_SWITCHING_ENABLED, LOCALE_COOKIE, normalizeLocale } from "@/lib/i18n/config";
...
export async function getLocale() {
  if (!LANGUAGE_SWITCHING_ENABLED) return DEFAULT_LOCALE;
